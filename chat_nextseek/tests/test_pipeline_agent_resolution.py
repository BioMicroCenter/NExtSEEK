...
from chat_nextseek.pipeline_agent import _resolve_samples
...
def test_resolve_last_search_walks_to_filtered_leaves():
    ...
    with patch("chat_nextseek.pipeline_agent.fetch_reporter_metadata") as fetch_md:
        fetch_md.return_value = {"ok": True, **_bundle_with_two_rnaseq_and_one_wgs()}
        with patch("chat_nextseek.pipeline_agent.annotate_metadata_with_sampletypes",
