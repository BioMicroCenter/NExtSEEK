...
> `- [ ]` checkboxes. Read `docs/2026-08-03-nessie-hardening-handoff-1-harness-corpus.md`
> **first** — it carries the environment, the traps and the cross-plan constraints.

**Design:** `docs/2026-08-03-nessie-hardening-design.md` (tracks B2, C1, C2, C3, D1-overlay, D2)
