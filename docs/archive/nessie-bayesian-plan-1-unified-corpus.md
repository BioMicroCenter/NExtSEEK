...
**Spec:** `docs/archive/nessie-bayesian-mode-design.md` §6. This plan implements Phase 1 only. Plans 2 and 3 cover the runner and the evaluation pipeline.
...
**Then** proceed to plan 2 (`docs/archive/nessie-bayesian-plan-2-runner.md`), which extracts `run_case()` and adds the forced-route paired driver.
