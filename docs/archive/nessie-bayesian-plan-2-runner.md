...
**Spec:** `docs/archive/nessie-bayesian-mode-design.md` §7. **Depends on plan 1 being complete** (`corpus.bayesian_ids()` and `corpus.hibayes_meta()` must exist).
...
**Then** proceed to plan 3 (`docs/archive/nessie-bayesian-plan-3-evaluation.md`).
