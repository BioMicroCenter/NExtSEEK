...
*Read this before `docs/archive/2026-08/2026-08-03-nessie-hardening-plan-1-harness-corpus.md`.
...
1. `docs/archive/2026-08/2026-08-03-nessie-hardening-design.md` — §3 (corrections), §5 (B2), §6 (C1-C3), §7 (D1-D2)
2. `/home/cdemu/nessie-seed6b-review.html` — the run this plan is reacting to
3. `docs/archive/nessie-corpus-review-findings-2026-07-30.md` — why only 6% of the corpus could
