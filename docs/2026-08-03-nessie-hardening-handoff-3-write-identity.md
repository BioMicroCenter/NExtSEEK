...
*Read this before `docs/2026-08-03-nessie-hardening-plan-3-write-identity.md`.
...
1. `docs/2026-08-03-nessie-hardening-design.md` §8 — the full argument, with every citation
...
5. `docs/nessie-corpus-review-findings-2026-07-30.md` — standing context on how little the
