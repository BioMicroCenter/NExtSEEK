...
class AdminRetrieveRequestSerializer(serializers.Serializer):
    """Request body for admin sample retrieval.
    Accepts either a list of UIDs or a whitespace-separated string.
    """
    retrieval_uids = serializers.ListField(child=serializers.CharField(), required=False)
