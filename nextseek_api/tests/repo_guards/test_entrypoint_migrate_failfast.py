...
def _run_entrypoint(
    ...
    env = {
        **os.environ,
        ...
        # on, every run here blocks until the timeout. Its own contract is
        # `nextseek_api/tests/test_graph_sync_entrypoint.py`, which runs the
        # marked block by itself with `sleep` stubbed too.
