...
- Doc drift folded in or explicitly deferred: 9-vs-8 op reconciliation (SPEC-7 §8/PLAN-7 Task 15 vs `BIN_OPS`=8 + stale 'nine' docstrings), DEPLOY.md rewrite (7c).
