...
SCHEMA = [
    ...
    ("CREATE TABLE IF NOT EXISTS sample_controlled_vocabs (id BIGINT PRIMARY KEY,title VARCHAR(255) NOT NULL,created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6))", ()),
