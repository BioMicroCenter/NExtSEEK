...
class QueryRequest(BaseModel):
    ...
    force_route: Optional[Literal["auto", "ns", "cc"]] = Field(
        None,
        description=(
            "Admin-only: supersede the BAML router for this query. 'ns' forces the "
            "core chat_nextseek path, 'cc' forces Container-Claude-Code, 'auto'/None "
            "uses the router. Ignored for non-admins (the server re-checks "
