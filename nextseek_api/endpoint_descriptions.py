...
GRAPH_SEARCH_DESC = (
    ...
    "type, `filter_matchType` applying; and `lineage`, `{direction: ancestor or descendant, sample_type, max_hops: "
    "1 to 4}`. Query parameters: `page` (1-based), `page_size` (default 100, max 1000), `debug_meta=1`.\n\n"
