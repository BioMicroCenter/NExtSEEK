# Generated by Django 4.2.23 on 2025-09-10 18:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clade', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='seek.clades')),
                ('sample_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='seek.sample_types')),
            ],
            options={
