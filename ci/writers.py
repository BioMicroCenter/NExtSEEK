...
WRITERS: tuple[Writer, ...] = (
    ...
    Writer(id="WR-25",
           sites=("scripts/graph_search/load_graph_backup.py::<module>",
                  ...
                  "scripts/graph_search/synthetic_parity.py::load_mysql",
                  "scripts/graph_search/synthetic_parity.py::scale_timing",
                  "scripts/graph_search/synthetic_parity.py::lineage_scale"),
           tables=("samples", "sample_types", "sample_attributes", "projects_samples", "projects",
                   ...
                   "internal_assays", "sample_attribute_types"),
           how=("cypher", "sql_file", "shell", "sql"),
           reconcile="RECONCILE_OPERATOR",
           note="the graph_search lane's own tools: they load a whole graph or a scratch MySQL, never a live "
                "instance, and parity.py's Cypher is a write the read session must refuse; synthetic_parity.py "
                "fills an empty throwaway MySQL and Neo4j that synthetic_parity.sh starts and removes"),
    Writer(id="WR-26",
