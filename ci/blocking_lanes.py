...
the Graph Search and Sample Search pages' view and JavaScript tests under seek/tests/.
...
BLOCKING_GLOBS = (
    ...
    # graph_search: its view tests and its JavaScript cases, which skip the same way.
