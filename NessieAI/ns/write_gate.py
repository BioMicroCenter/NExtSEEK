...
* every other (read-class) op — entity / parse / graph / graph-schema / aggregate /
  report / generate-submission — always passes.
...
# _ws_contract.SIDECAR_OPS, plus graph-schema and aggregate). The transport-truth set is
# larger: run-ls and build-upload-xlsx are dispatched without ever calling the gate
