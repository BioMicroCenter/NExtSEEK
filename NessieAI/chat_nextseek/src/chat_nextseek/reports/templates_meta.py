...
def normalize_report_type(report_type: str | None) -> str | None:
    ...
    alias_map = {
        ...
        "NFCORE_RNAFUSION": "NFCORE_RNAFUSION",
        "NFCORE_RNAFUSION_SAMPLESHEET": "NFCORE_RNAFUSION",
        "NF_CORE_RNAFUSION": "NFCORE_RNAFUSION",
        "NFCORE_RNASPLICE": "NFCORE_RNASPLICE",
        "NFCORE_RNASPLICE_SAMPLESHEET": "NFCORE_RNASPLICE",
        "NF_CORE_RNASPLICE": "NFCORE_RNASPLICE",
        ...
        "NFCORE_CRISPRSEQ": "NFCORE_CRISPRSEQ",
        "NFCORE_CRISPRSEQ_SAMPLESHEET": "NFCORE_CRISPRSEQ",
        "NF_CORE_CRISPRSEQ": "NFCORE_CRISPRSEQ",
        "NFCORE_NANOSEQ": "NFCORE_NANOSEQ",
        "NFCORE_NANOSEQ_SAMPLESHEET": "NFCORE_NANOSEQ",
        "NF_CORE_NANOSEQ": "NFCORE_NANOSEQ",
        "NFCORE_MAG": "NFCORE_MAG",
        "NFCORE_MAG_SAMPLESHEET": "NFCORE_MAG",
        "NF_CORE_MAG": "NFCORE_MAG",
        ...
        "NFCORE_BAMTOFASTQ": "NFCORE_BAMTOFASTQ",
        "NFCORE_BAMTOFASTQ_SAMPLESHEET": "NFCORE_BAMTOFASTQ",
        "NF_CORE_BAMTOFASTQ": "NFCORE_BAMTOFASTQ",
        "NFCORE_BACASS": "NFCORE_BACASS",
        "NFCORE_BACASS_SAMPLESHEET": "NFCORE_BACASS",
        "NF_CORE_BACASS": "NFCORE_BACASS",
        "NFCORE_BACTMAP": "NFCORE_BACTMAP",
        "NFCORE_BACTMAP_SAMPLESHEET": "NFCORE_BACTMAP",
        "NF_CORE_BACTMAP": "NFCORE_BACTMAP",
        "NFCORE_PACVAR": "NFCORE_PACVAR",
        "NFCORE_PACVAR_SAMPLESHEET": "NFCORE_PACVAR",
        "NF_CORE_PACVAR": "NFCORE_PACVAR",
        "NFCORE_VIRALRECON": "NFCORE_VIRALRECON",
        "NFCORE_VIRALRECON_SAMPLESHEET": "NFCORE_VIRALRECON",
        "NF_CORE_VIRALRECON": "NFCORE_VIRALRECON",
        "NFCORE_VIRALMETAGENOME": "NFCORE_VIRALMETAGENOME",
        "NFCORE_VIRALMETAGENOME_SAMPLESHEET": "NFCORE_VIRALMETAGENOME",
        "NF_CORE_VIRALMETAGENOME": "NFCORE_VIRALMETAGENOME",
        "NFCORE_VIRALINTEGRATION": "NFCORE_VIRALINTEGRATION",
        "NFCORE_VIRALINTEGRATION_SAMPLESHEET": "NFCORE_VIRALINTEGRATION",
        "NF_CORE_VIRALINTEGRATION": "NFCORE_VIRALINTEGRATION",
        "NFCORE_MAGMAP": "NFCORE_MAGMAP",
        "NFCORE_MAGMAP_SAMPLESHEET": "NFCORE_MAGMAP",
        "NF_CORE_MAGMAP": "NFCORE_MAGMAP",
        "NFCORE_METATDENOVO": "NFCORE_METATDENOVO",
        "NFCORE_METATDENOVO_SAMPLESHEET": "NFCORE_METATDENOVO",
        "NF_CORE_METATDENOVO": "NFCORE_METATDENOVO",
        "NFCORE_DENOVOTRANSCRIPT": "NFCORE_DENOVOTRANSCRIPT",
        "NFCORE_DENOVOTRANSCRIPT_SAMPLESHEET": "NFCORE_DENOVOTRANSCRIPT",
        "NF_CORE_DENOVOTRANSCRIPT": "NFCORE_DENOVOTRANSCRIPT",
        "NFCORE_DETAXIZER": "NFCORE_DETAXIZER",
        "NFCORE_DETAXIZER_SAMPLESHEET": "NFCORE_DETAXIZER",
        "NF_CORE_DETAXIZER": "NFCORE_DETAXIZER",
        "NFCORE_FASTQREPAIR": "NFCORE_FASTQREPAIR",
        "NFCORE_FASTQREPAIR_SAMPLESHEET": "NFCORE_FASTQREPAIR",
        "NF_CORE_FASTQREPAIR": "NFCORE_FASTQREPAIR",
        "NFCORE_GENOMEASSEMBLER": "NFCORE_GENOMEASSEMBLER",
        "NFCORE_GENOMEASSEMBLER_SAMPLESHEET": "NFCORE_GENOMEASSEMBLER",
        "NF_CORE_GENOMEASSEMBLER": "NFCORE_GENOMEASSEMBLER",
        "NFCORE_PATHOGENSURVEILLANCE": "NFCORE_PATHOGENSURVEILLANCE",
        "NFCORE_PATHOGENSURVEILLANCE_SAMPLESHEET": "NFCORE_PATHOGENSURVEILLANCE",
        "NF_CORE_PATHOGENSURVEILLANCE": "NFCORE_PATHOGENSURVEILLANCE",
    }
