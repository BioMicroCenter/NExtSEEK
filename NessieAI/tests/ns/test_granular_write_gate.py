...
AUDIT_READ_ENDPOINTS = [
    # The download API by its new name only (2026-09-24). The old admin/samples/retrieve/ alias left
    # the CC allowlist; the server still answers it, so saved NS chats replay through the REST tool.
