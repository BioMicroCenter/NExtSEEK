...
@pytest.mark.parametrize("reply,expected", [
    ...
    ("Samples from St. Jude Children's Hospital number 98. Two.",
     f"Samples from St. Jude Children's Hospital number 98. {F} Two."),
    ("Sample No. 5 is the largest, with 98 files. Two.", f"Sample No. 5 is the largest, with 98 files. {F} Two."),
    ("All 98 came from U.S. National Cancer Institute sites. Two.",
     f"All 98 came from U.S. National Cancer Institute sites. {F} Two."),
    ("Reads were sequenced by Illumina Inc. Sequencing Services. Two.",
     f"Reads were sequenced by Illumina Inc. Sequencing Services. {F} Two."),
    ("Data from Mt. Sinai sites number 98. Two.", f"Data from Mt. Sinai sites number 98. {F} Two."),
